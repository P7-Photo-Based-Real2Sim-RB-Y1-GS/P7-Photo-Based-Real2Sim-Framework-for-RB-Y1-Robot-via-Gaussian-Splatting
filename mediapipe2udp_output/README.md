...
This project uses the Intel RealSense D435i camera and Google’s open-source MediaPipe 0.10.9 version framework at python virtual environment.<br><br>Python version 3.8 or higher is required.
